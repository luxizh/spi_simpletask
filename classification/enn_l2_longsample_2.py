...
def generate_data(label):
    ...
    for i in range(input_len):
        ...
        organisedData[neuid].append(input_len*v_co*1+i*v_co)
        organisedData[neuid].append(input_len*v_co*2+i*v_co)
        organisedData[neuid].append(input_len*v_co*3+i*v_co)
        organisedData[neuid].append(input_len*v_co*4+i*v_co)
